...
import Zuali.modules.sql.notes_sql as sql
from Zuali import dispatcher, LOGGER, OWNER_ID, SUDO_USERS, MESSAGE_DUMP
from Zuali.__main__ import DATA_IMPORT
from Zuali.modules.helper_funcs.chat_status import user_admin
from Zuali.modules.helper_funcs.misc import build_keyboard, revert_buttons
from Zuali.modules.helper_funcs.msg_types import get_note_type
from Zuali.modules.rules import get_rules
import Zuali.modules.sql.rules_sql as rulessql
from Zuali.modules.sql import warns_sql as warnssql
import Zuali.modules.sql.blacklist_sql as blacklistsql
from Zuali.modules.sql import disable_sql as disabledsql
from Zuali.modules.sql import cust_filters_sql as filtersql
import Zuali.modules.sql.welcome_sql as welcsql
import Zuali.modules.sql.locks_sql as locksql
from Zuali.modules.connection import connected
...
def export_data(bot: Bot, update: Update, chat_data):
    ...
    f=open("Zuali{}.backup".format(chat_id), "w")
    ...
    try:
        ...
        pass
    bot.sendDocument(current_chat_id, document=open('Zuali{}.backup'.format(chat_id), 'rb'), caption="*Successfully imported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This  is specially made for notes.".format(chat.title, chat_id, tgl), timeout=360, reply_to_message_id=msg.message_id, parse_mode=ParseMode.MARKDOWN)
    os.remove("Zuali{}.backup".format(chat_id)) # Cleaning file
