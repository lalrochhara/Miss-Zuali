...
if ENV:
    ...
    from Zuali.config import Development as Config
...
telethn = TelegramClient("Zuali", api_id, api_hash)
...
from Zuali.modules.helper_funcs.handlers import CustomCommandHandler, CustomRegexHandler, CustomMessageHandler
